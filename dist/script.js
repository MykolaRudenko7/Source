...
var modals = function modals() {
  ...
  function bindModal(selectorBtn, modalWindow, close) {
    ...
    selectorBtn.addEventListener("click", function (e) {
      ...
      modalWindow.style.display = "block"; // поки не закриєш, сайт не гортатиметься

      document.body.style.overflow = "hidden"; // при клікові на хрестик, закриваю вікно і далі гортаю

      close.addEventListener("click", function () {
        modalWindow.style.display = "none"; // поки не закриєш, сайт не гортатиметься
  ...
  var EngineerClose = document.querySelector(".popup_engineer .popup_close");
