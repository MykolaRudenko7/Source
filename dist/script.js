     ...
     */ !(function (t, n) {
          ...
          function (e, t) {
            S.fn[e] = function (n, i) {
              ...
              return (
                ...
                this.length > 1 &&
                  (H[e] || S.uniqueSort(o), P.test(e) && o.reverse()),
                this.pushStack(o)
              );
            };
          }
      ...
      function Te(e, t, n, i, o) {
        ...
        for (d.textContent = "", f = 0; (r = p[f++]); )
          if (i && S.inArray(r, i) > -1) o && o.push(r);
            ...
            ((c = se(r)), (s = we(d.appendChild(r), "script")), c && xe(s), n)
          )
        ...
        special: {
          ...
          click: {
            ...
            trigger: function (e) {
              var t = this || e;
              return (
                ve.test(t.type) && t.click && j(t, "input") && Ee(t, "click"),
                !0
              );
            },
            _default: function (e) {
      ...
      function Me(e, t, n, i) {
        ...
        if (
          ...
          if (a)
            for (
              u = s[s.length - 1].ownerDocument, S.map(s, Pe), d = 0;
              d < a;
              d++
            )
              (c = s[d]),
              ...
              : ((n = wt(e)),
                this.each(function () {
                  if (a)
                    ...
                    (void 0 !== e && "boolean" !== s) ||
                      ((i = mt(this)) && J.set(this, "__className__", i),
                      this.setAttribute &&
                        this.setAttribute(
                          "class",
                          i || !1 === e
      ...
      S.extend(S.event, {
        trigger: function (e, t, i, o) {
          ...
          if (
            ...
            if (!o && !d.noBubble && !m(i)) {
              for (
                l = d.delegateType || v, bt.test(l + v) || (s = s.parentNode);
                s;
                s = s.parentNode
              )
                h.push(s), (a = s);
      ...
      S.ajaxSetup({
        ...
        S.each(["top", "left"], function (e, t) {
          S.cssHooks[t] = Xe(g.pixelPosition, function (e, n) {
            if (n)
              return (n = Ue(e, t)), _e.test(n) ? S(e).position()[t] + "px" : n;
          });
        }),
      ...
      return (
        (S.noConflict = function (e) {
          return (
            n.$ === S && (n.$ = Jt), e && n.jQuery === S && (n.jQuery = Qt), S
          );
        }),
        ...
        function (e, t, n, i) {
          ...
          function l() {
            a.forEach(function (e) {
              (e.style.display = "none"), e.classList.remove("faded");
            }),
      ...
      d = function () {
        ...
        e.classList.add("popup"),
          ...
          t.addEventListener("click", function (t) {
            if (
              (t.preventDefault(),
              t.target && t.target.classList.contains("preview"))
            ) {
              (e.style.display = "flex"),
                (document.body.style.overflow = "hidden"),
                (n.style.cssText =
                  "\n\t\t\twidth: 50%;\n  \t\t\theight: auto;\n\t\t");
              var i = t.target.parentNode.getAttribute("href");
              n.setAttribute("src", i);
            }
            t.target &&
              t.target.matches("div.popup") &&
              ((e.style.display = "none"),
